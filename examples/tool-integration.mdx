...
This example demonstrates how to integrate tools using the Model Context Protocol (MCP) with HAIP, including tool advertisement, invocation, progress updates, and completion handling.
...
This example demonstrates how to build a comprehensive tool integration system using HAIP's MCP capabilities. 