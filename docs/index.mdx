...
<CardGroup cols={3}>
  <Card title="@haip/sdk" icon="code">
    [![npm version](https://badge.fury.io/js/%40haip%2Fsdk.svg)](https://badge.fury.io/js/%40haip%2Fsdk)<br/>
    TypeScript SDK for HAIP
  </Card>
  <Card title="@haip/server" icon="server">
    [![npm version](https://badge.fury.io/js/%40haip%2Fserver.svg)](https://badge.fury.io/js/%40haip%2Fserver)<br/>
    Reference HAIP server
  </Card>
  <Card title="@haip/cli" icon="terminal">
    [![npm version](https://badge.fury.io/js/%40haip%2Fcli.svg)](https://badge.fury.io/js/%40haip%2Fcli)<br/>
...
<Columns cols={2}>
  ...
  <Card
    title="Robust Streaming"
    icon="arrow-up"
    href="/essentials/transport"
  >
