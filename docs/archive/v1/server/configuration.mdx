---
title: "HAIP 1 archive — Configuration"
...
- [Transports](/archive/v1/server/transports) - Configure different transport options
- [Tools](/archive/v1/server/tools) - Add custom tools to the server
- [Monitoring](/archive/v1/server/monitoring) - Set up monitoring and alerting
