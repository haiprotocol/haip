---
title: "HAIP 1 archive — HAIP Server Overview"
...
- [Installation Guide](/archive/v1/server/installation) - Set up the server
- [Quick Start](/archive/v1/server/quickstart) - Get up and running quickly
- [Configuration](/archive/v1/server/configuration) - Configure the server
