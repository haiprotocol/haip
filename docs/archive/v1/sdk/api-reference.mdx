---
title: "HAIP 1 archive — API Reference"
...
<CardGroup cols={2}>
  ...
  <Card title="Types" href="/archive/v1/sdk/api-reference" icon="laptop">
    Explore detailed type definitions.
  </Card>
  <Card title="Utilities" href="/archive/v1/sdk/api-reference" icon="wrench">
