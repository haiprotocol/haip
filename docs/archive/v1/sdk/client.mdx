---
title: "HAIP 1 archive — Client API"
...
<ParamField
  body="transport"
  type="'websocket' | 'sse' | 'http-streaming'"
  default="'websocket'"
>
...
<CardGroup cols={2}>
  <Card title="Transports" href="/archive/v1/sdk/transports" icon="wifi">
  ...
  <Card title="Types" href="/archive/v1/sdk/api-reference" icon="code">
