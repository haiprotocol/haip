...
Extend your HAIP applications with powerful tool integration capabilities. Leverage
the Model Context Protocol (MCP) to connect AI agents with external services, APIs,
and custom tools for enhanced functionality.
...
<CardGroup cols={2}>
  ...
  <Card title="Error Handling" href="/archive/v1/sdk/error-handling" icon="exclamation">
    Understand error handling and recovery.
  </Card>
  <Card title="API Reference" href="/archive/v1/sdk/api-reference" icon="laptop">
