---
title: "HAIP 1 archive — Quick Start"
...
- HAIP CLI installed (see [Installation](/archive/v1/cli/installation))
- A HAIP server running (see [HAIP Server](/archive/v1/server/overview))
...
- [Configuration](/archive/v1/cli/configuration) - Advanced configuration options
- [Examples](/archive/v1/examples/using-cli) - More usage examples and patterns
- [API Reference](/archive/v1/cli/api-reference) - Technical API documentation
