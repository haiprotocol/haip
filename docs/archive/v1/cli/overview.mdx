...
<CardGroup cols={2}>
  <Card title="Multiple Transports" icon="network-wired" href="/archive/v1/cli/commands">
    WebSocket, SSE, and HTTP streaming support with automatic connection
    management.
  </Card>
  <Card title="Real-time Monitoring" icon="eye" href="/archive/v1/cli/commands">
    Monitor server events with filtering, formatting, and follow mode.
  </Card>
  <Card title="Performance Testing" icon="chart-line" href="/archive/v1/cli/commands">
    Test server connectivity and performance with configurable parameters.
  </Card>
  <Card title="Health Checks" icon="heart" href="/archive/v1/cli/commands">
    Check server health status with JSON and text output formats.
  </Card>
  <Card title="Message Sending" icon="message" href="/archive/v1/cli/commands">
    Send text messages, tool calls, and run commands with full protocol support.
  </Card>
  <Card title="Interactive Mode" icon="terminal" href="/archive/v1/cli/commands">
...
- [Installation Guide](/archive/v1/cli/installation) - Set up the CLI
- [Quick Start](/archive/v1/cli/quickstart) - Get up and running quickly
- [Command Reference](/archive/v1/cli/commands) - Complete command documentation
- [Configuration](/archive/v1/cli/configuration) - Configure the CLI
- [Examples](/archive/v1/examples/using-cli) - Usage examples and patterns
