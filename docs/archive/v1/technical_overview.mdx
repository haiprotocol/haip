---
title: "HAIP 1 archive — Technical Overview"
...
<Card
  ...
  icon="book-open"
  href="/archive/v1/protocol/overview"
  horizontal
>
...
<Card
  ...
  icon="exclamation"
  href="/archive/v1/protocol/essentials/error-handling"
>
...
<Card title="Monitoring" icon="chart-line" href="/archive/v1/server/monitoring">
...
<Accordion icon="wrench" title="HAIP CLI">
  ...
  <Note>
    ...
    documentation](/archive/v1/cli/overview) for complete usage guide.
  </Note>
</Accordion>
