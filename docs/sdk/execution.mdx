...
`verifyExecutionAuthority` validates an execution request together with its candidate, signed decision receipt, exclusive claim and fresh admission response. Supply the exact retained payload, response schema, static document and optional App bytes.
