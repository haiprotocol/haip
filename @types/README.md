...
Generated protocol types, strict JSON, RFC 8785 canonicalisation and Ed25519 primitives.
The package also includes the independent draft documents, JSON Schema and OpenAPI
