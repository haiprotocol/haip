...
Generated protocol types, strict JSON, RFC 8785 canonicalisation and Ed25519 primitives. The package also includes the independent draft documents, JSON Schema and OpenAPI under `contracts/`. Schema exports are `@haip/protocol/schema.json` and `@haip/protocol/openapi.json`. The contract itself does not require Node or PostgreSQL.
