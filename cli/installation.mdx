...
<Steps>
  ...
  <Step title="Verify Installation">
    ...
    You should see the HAIP CLI banner and help information.
  </Step>
</Steps>
...
<Note>
  **Coming Soon**: The HAIP CLI will be available on npm as `@haip-protocol/cli` in the near future.
</Note>
...
<Note>
  **Coming Soon**: Docker images will be available on Docker Hub as `haiprotocol/cli`.
</Note>

### Pull the Image

```bash
docker pull haiprotocol/cli:latest
```
...
docker run -it haiprotocol/cli:latest --help

# Run with volume mount for configuration
docker run -it -v $(pwd):/workspace haiprotocol/cli:latest health
```
