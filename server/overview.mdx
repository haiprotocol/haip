...
description: "Complete reference implementation of the HAIP server"
---

The HAIP Server is a complete, production-ready reference implementation of the HAIP. It provides a fully functional server that supports all HAIP transport types, authentication, tool integration, and monitoring capabilities.
...
- **NPM**: `@haip/server` (coming soon)
- **Docker Hub**: `haip-protocol/server` (coming soon)
