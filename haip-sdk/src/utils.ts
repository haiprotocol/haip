...
export class HAIPUtils {
  ...
  static createRunStartedMessage(
    ...
    return this.createMessage(sessionId, "SYSTEM", "RUN_STARTED", {
      run_id: runId,
  ...
  static createRunFinishedMessage(
    ...
    return this.createMessage(sessionId, "SYSTEM", "RUN_FINISHED", {
      run_id: runId,
      ...(status && { status }),
      ...(summary && { summary })
    }, { run_id: runId });
  ...
  static createRunCancelMessage(
    ...
    return this.createMessage(sessionId, "SYSTEM", "RUN_CANCEL", {
      run_id: runId
    }, { run_id: runId });
  }
  ...
  static createRunErrorMessage(
    ...
    return this.createMessage(sessionId, "SYSTEM", "RUN_ERROR", {
      run_id: runId,
      code,
      message,
   ...
   */
  static calculateBackoffDelay(attempt: number, baseDelay: number = 1000, maxDelay: number = 30000): number {
