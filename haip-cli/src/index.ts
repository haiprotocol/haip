...
program.addCommand(
    new Command("version").description("Show version information").action(() => {
...
program.addCommand(
    new Command("info").description("Show system information").action(() => {
...
program.addCommand(
    new Command("examples").description("Show usage examples").action(() => {
        ...
        console.log(chalk.gray("  haip monitor --filter-types MESSAGE_START,TOOL_CALL"));
