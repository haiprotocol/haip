...
import { HAIPMessage, HAIPCLIOutput, HAIPCLIStats } from "./types";
...
`;
  ...
  static createTextMessage(channel: string, text: string, author?: string, runId?: string): HAIPMessage {
    return {
      id: this.generateId(),
      seq: this.generateSequence(),
      ts: this.formatTimestamp(),
  ...
  static createToolCallMessage(channel: string, tool: string, params: Record<string, any>, runId?: string): HAIPMessage {
    return {
      id: this.generateId(),
      seq: this.generateSequence(),
      ts: this.formatTimestamp(),
